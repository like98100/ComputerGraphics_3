...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	m_Camera->SetPosition(0.0f, 0.0f, -45.0f);
	...
	result = m_Model[0]->Initialize(m_D3D->GetDevice(), (char*)"../0503/Model0.txt", (WCHAR *)L"../0503/data/wooden stool texture(F).png");
	if (!result)
	{
	...
	result = m_Model[1]->Initialize(m_D3D->GetDevice(), (char*)"../0503/Model1.txt", (WCHAR *)L"../0503/data/Axe.png");
	if (!result)
	{
		MessageBox(hwnd, L"Could not initialize the model object.", L"Error", MB_OK);
		return false;
	...
	result = m_Model[2]->Initialize(m_D3D->GetDevice(), (char*)"../0503/Model2.txt", (WCHAR *)L"../0503/data/Bar_Chair_C.jpg");
	if (!result)
	{
		MessageBox(hwnd, L"Could not initialize the model object.", L"Error", MB_OK);
		return false;
...
bool GraphicsClass::Render(float rotation)
{
	...
	result = m_LightShader->Render(m_D3D->GetDeviceContext(), m_Model[1]->GetIndexCount(), worldMatrix,
