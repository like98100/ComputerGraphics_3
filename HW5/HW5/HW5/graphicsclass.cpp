...
GraphicsClass::GraphicsClass()
{
	...
	modelName[0] = (char*)"../HW5/data/cube.txt";
	modelName[1] = (char*)"../HW5/data/Triangular.txt";
	modelName[2] = 0;
	textureName[0] = (WCHAR *)L"../HW5/data/mine.dds";
	textureName[1] = (WCHAR *)L"../HW5/data/seafloor.dds";
	textureName[2] = 0;
	cntRender = 0;
}
...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Model->Initialize(m_D3D->GetDevice(), (char*)"../HW5/data/cube.txt", (WCHAR *)L"../HW5/data/mine.dds");
	if (!result)
	{
	...
	m_Light->SetDiffuseColor(0.75f, 0.75f, 0.25f, 0.6f);
	m_Light->SetDirection(1.0f, 1.5f, 1.5f);
