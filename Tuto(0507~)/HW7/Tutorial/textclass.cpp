	...
	D3DXMATRIX baseViewMatrix)
{
	...
	result = m_Font->Initialize(device, (char*)"../Tutorial/data/fontdata.txt", (WCHAR*)L"../Tutorial/data/font.dds");
	if (!result)
	{
	...
	result = UpdateSentence(m_sentence1, (char*)"Pencil", 175, 500, 1.0f, 0.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence2, (char*)"Western Sword", 250, 500, 0.0f, 1.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence3, (char*)"Barrel", 350, 500, 0.0f, 0.0f, 1.0f, deviceContext);
	if (!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence4, (char*)"Eastern Sword", 425, 500, 1.0f, 1.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence5, (char*)"Tree", 550, 500, 0.0f, 0.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
